var _STRINGS = {
    Ad: {
        Mobile: {
            Preroll: {
                ReadyIn: "Sẵn sàng chiến đấu",
                Loading: "Trận chiến của bạn đang được tải...",
                Close: "Đóng"
            },
            Header: {
                ReadyIn: "Sẵn sàng chiến đấu",
            ...
            End: {
                ReadyIn: "Quảng cáo kết thúc sau",
    ...
    Splash: {
        Loading: "Đang tải...",
        LogoLine1: "Một vài dòng chữ ở đây",
        LogoLine2: "Được hỗ trợ bởi MarketJS (Việt hóa)",
        LogoLine3: "Không có ai"
    },
    Game: {
        SelectPlayer: "Chọn người chơi",
        Win: "Chúc mừng, bạn đã thắng!",
        Lose: "Rất tiếc, bạn đã thua!",
        Score: "Điểm",
        Time: "Thời gian còn lại",
        Home: "Trở lại",
        Battle: "Bắt đầu",
        CardCollection: "Tất cả thẻ bài",
        ReplaceCard: "Chọn thẻ để thay thế",
        Use: "Sử dụng",
        Info: "Chi tiết",
        Sixty: "60",
        Thirty: "30",
        TimeMinutes: "giây",
        LeftMinutes: "phút",
        DoubleElixer: "X2 Năng lượng",
        AdditionalSixty: "+60",
        Extra: "Thêm",
        Sudden: "Kết thúc đột ngột",
        TropiExtra: "- Nhận cúp tiếp theo -",
        Tutorial: "Hướng dẫn",
        StartTutorial: "Bạn có muốn xem hướng dẫn trước không?",
        Yes: "Xem ngay",
        No: "Không cần",
        Pause: "Tạm dừng",
        GamePause: "Trò chơi đã tạm dừng",
        Resume: "Tiếp tục",
        Health: "Sinh lực",
        Duration: "Thời gian hiệu lực",
        Movement: "Tốc độ di chuyển",
        Type: "Loại:",
        Spell: "Phép thuật",
        Troop: "Quân đội",
        Damage: "Sát thương",
        ...
        Normal: "Bình thường",
        Slow: "Chậm",
        DamagePerSecond: "Sát thương mỗi giây",
    ...
    Tutorial: {
        Welcome: "Chào mừng trở lại, hãy bắt đầu huấn luyện",
        Destroy: "Mục tiêu của chúng ta là phá hủy tháp của kẻ địch",
        Ready: "Giờ thì bắt đầu chiến đấu! Chúc bạn may mắn",
        Deploy: "Kéo thả thẻ bài để triển khai quân đội"
    },
    Results: {
        Title: "Điểm cao"
    }
...
_GAME = {
    Card: {
        archer: {
            ...
            ATK: 45,
            spellcard: !1,
            description: "Xạ thủ là đơn vị tấn công tầm xa, sử dụng mũi tên sắc bén để hạ gục kẻ địch"
        },
        ars: {
            name: "Mưa tên",
            manaUsage: 3,
            ...
            spellcard: !0,
            damage: 300,
            description: "Cơn mưa tên che kín bầu trời, gây sát thương diện rộng lên kẻ địch"
        },
        warrior: {
            name: "Chiến binh cuồng nộ",
            manaUsage: 4,
            indexCardNumber: 3,
            range: !1,
            rangeShot: 0,
            ...
            ATK: 95,
            spellcard: !1,
            description: "Lính đánh thuê với thanh kiếm sắc bén, chém đôi kẻ thù"
        },
        berserk: {
            name: "Cuồng chiến",
            manaUsage: 3,
            ...
            range: !0,
            spellcard: !0,
            description: "Đưa quân đội vào trạng thái điên cuồng, tăng tốc độ tấn công"
        },
        giant: {
            name: "Người khổng lồ hộ vệ",
            manaUsage: 5,
            indexCardNumber: 5,
            range: !1,
            rangeShot: 0,
            ...
            ATK: 75,
            spellcard: !1,
            description: "Tên cướp biển khổng lồ, chỉ tấn công các tòa tháp"
        },
        bomb: {
            name: "Người ném bom",
            manaUsage: 3,
            ...
            ATK: 50,
            spellcard: !1,
            description: "Ném bom vào kẻ địch, gây sát thương lan"
        },
        fireball: {
            name: "Cầu lửa",
            manaUsage: 4,
            ...
            spellcard: !0,
            damage: 500,
            description: "Quả cầu lửa rực cháy thiêu đốt kẻ thù"
        },
        freezer: {
            name: "Băng giá",
            manaUsage: 4,
            ...
            range: !0,
            spellcard: !0,
            description: "Luồng khí lạnh đóng băng tháp và đơn vị địch"
        },
        axeman: {
            name: "Kẻ cuồng chiến",
            manaUsage: 2,
            ...
            ATK: 65,
            spellcard: !1,
            description: "Nhỏ con nhưng nhanh nhẹn và nguy hiểm"
        },
        axethrow: {
            name: "Kẻ ném rìu",
            manaUsage: 3,
            ...
            ATK: 65,
            spellcard: !1,
            description: "Nổi tiếng với cơn thịnh nộ, ném rìu tiêu diệt kẻ thù"
        },
        hammer: {
            name: "Chiến binh búa điên loạn",
            manaUsage: 4,
            indexCardNumber: 11,
            range: !1,
            rangeShot: 0,
            ...
            ATK: 35,
            spellcard: !1,
            description: "Chiến binh cầm búa với sức mạnh và khả năng chịu đòn lớn"
        },
        lightning: {
            name: "Tia sét",
            manaUsage: 2,
            ...
            stunTime: 0.4,
            damage: 200,
            description: "Tia sét đánh trúng và làm choáng kẻ địch"
        },
        mage: {
            name: "Pháp sư",
            manaUsage: 4,
            ...
            ATK: 75,
            spellcard: !1,
            description: "Pháp sư sử dụng ngọn lửa tự nhiên để tiêu diệt kẻ thù"
        },
        tombcrush: {
            name: "Búa sấm sét",
            manaUsage: 4,
            ...
            range: !0,
            spellcard: !1,
            description: "Chiếc búa từ thiên đường giáng xuống, gây sát thương và làm chậm kẻ địch"
        }
    }
};
